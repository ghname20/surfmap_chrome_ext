var keylib = function () {
	 ...
	 */
	var translate_event = function (e) {
		//e = e || window.event;
	...
	var hot_key_event = function (event) {
		var key = translate_event(event);
		var hk = hot_key(key);
		return hk;
	};
	...
	var KeyCode = {
		...
		translate_key_code: translate_key_code,
		translate_event: translate_event,
		key_down: key_down,
		key_up: key_up,
		is_down: is_down,
		hot_key: hot_key,
		hot_key_event: hot_key_event
	}
